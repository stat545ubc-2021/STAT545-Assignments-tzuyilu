...
There are three functions in this package, including 'RegionSel', 'TreeAgeCal', and 'OutputSum'.
'SubGrpSel' extracts specific categories under a targeted column from the data set.
'TreeAgeCal' computes the tree age information according to the planted date and the specified reference date.
'OutputSum' generates a summary of chosen columns according to specific group..
